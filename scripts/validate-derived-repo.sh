...
require_file "config_surface.toml"
require_file "scripts/ci_flags.py"
require_file "scripts/config_surface.py"
require_file "scripts/validate_config_surface.py"
require_file "tests/unit/test_ci_flags.py"
require_file "tests/template/test_validate_template.py"
require_file "tests/template/test_validate_config_surface.py"
require_file "tests/template/test_generate_config_surface_docs.py"
...
require_file "scripts/generate_config_surface_docs.py"
...
require_file "docs/configuration-surface.md"
